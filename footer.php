<footer>
    <a href="#"><img src="/GENATE_WEB/recursos\Body\Boton_Salto.png"></a>
    <div class="footer-content center-r">
        ...
        <div class="footer-section">
            ...
            <ul class="list-img">
                <li class="item-sede">
                    <img src="/GENATE_WEB/recursos\Logos\Logo_Telefono.svg" class="icono-mapa">
                    <a href="#">933 257 830</a>
                </li>
                <li class="item-sede">
                    <img src="/GENATE_WEB/recursos\Logos\Logo_Correo.svg" class="icono-mapa">
