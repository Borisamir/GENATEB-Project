    ...
    <main>
        ...
        <div class="contenedor-monitoreo">
            <div class="contenedor-boton">
                <a href="https://wa.link/drs6v5" target="_blank" rel="noopener noreferrer" class="boton-verde">
                    COTIZA AQUI
                </a>
            </div>
        </div>
        ...
        <div class="contenedor-imagen-texto" style="border-bottom:3px #083D29 dotted">
            <div class="imagen-texto ancho-500">
                ...
                <p>Análisis de parámetros físicos,<br>químicos,orgánicos e<br>inorgánicos y barrido de metales</p>
            </div>
            <div class="imagen-texto ancho-500">
