    ...
    <main>
        <div class="contenedor-banner">
            <div class="contenedor-imagen">
                <img src="..\recursos\Imagenes_Seguridad_Salud\Banner_Seguridad.png">
            </div>
        </div>
        ...
        <div class="contenedor-monitoreo">
            <div class="contenedor-parrafo" >
                <h2>Ejecutamos una supervision eficiente cumpliendo con<br>los requisitos legales en los sectores de:construccion,<br>mineria e industria</h2>
            </div>
        </div>
        <div class="contenedor-monitoreo">
        ...
        <div class="contenedor-imagen-texto">
            <div class="imagen-texto" style="width: 400px;">
                ...
                <h2>Elaboracion y actualizacion<br>de documentacion</h2>
            </div>
            <div class="imagen-texto" style="width: 400px;">
                <img src="..\recursos\Imagenes_Seguridad_Salud\Cronometro.png" style="width: 159px;height: 159px;" >
                <h2>Seguimiento y<br>mantenimiento de SGSST</h2>
            </div>
        </div>
