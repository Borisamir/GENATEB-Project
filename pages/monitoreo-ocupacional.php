            ...
            <div class="font-inter">
                ...
                <div>
                    <div class="monitoreo-content mc-1 center-r">
                        ...
                        <ul>
                            <li>
                                <img src="<?php echo $_ENV["RESOURCES"]; ?>/Body/ocupacional-1.png" alt="ocupacional-1">
                                <p>Sonometría</p>
                            </li>
                            <li>
                ...
                <div>
                    <div class="monitoreo-content mc-5 center-r">
                        ...
                        <ul>
                            ...
                            <li>
                                <img src="<?php echo $_ENV["RESOURCES"]; ?>/Body/REBA.png" alt="reba">
                                <p>Metodología de análisis<br>REBA</p>
                            </li>
                            <li>
                                <img src="<?php echo $_ENV["RESOURCES"]; ?>/Body/RULA.png" alt="rula">
