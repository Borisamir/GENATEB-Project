...
<head>
    ...
    <link rel="stylesheet" href="/GENATE_WEB/styles/main.monitero-ocupacional.css">
...
<body>
    ...
    <main>
        ...
        <section class="monitoreos center">
            ...
            <div>
                <div class="monitoreo-content center-r">
                    ...
                    <ul>
                        <li>
                            <img src="..\recursos/Body/ocupacional-1.png" alt="ocupacional-1">
                            <p>cuestionario<br><span>copso</span>q-<span>istas<span> 21</p>
                        </li>
                        <li>
                            <img src="..\recursos/Body/ocupacional-2.png" alt="ocupacional-2">
                            <p>Cuestionario<br><span>suceso-istas</span> 21</p>
                        </li>
                        <li>
                            <img src="..\recursos/Body/ocupacional-3.png" alt="ocupacional-3">
            ...
            <div>
                <div class="monitoreo-content center-r">
                    ...
                    <ul>
                        <li>
                            <img src="..\recursos/Body/ocupacional-1.png" alt="ocupacional-1">
                            <p>Metodología de análisis<br><span>owas</span></p>
                        </li>
                        <li>
                            <img src="..\recursos/Body/ocupacional-2.png" alt="ocupacional-2">
                            <p>dosimetríaMetodología de análisis<br><span>rosa</span></p>
                        </li>
                        <li>
                            <img src="..\recursos/Body/ocupacional-3.png" alt="ocupacional-3">
                            <p>Metodología de análisis<br><span>reba</span></p>
                        </li>
                        <li>
                            <img src="..\recursos/Body/ocupacional-4.png" alt="ocupacional-4">
                            <p>Metodología de análisis<br><span>rula</span></p>
                        </li>
                        <li>
                            <img src="..\recursos/Body/ocupacional-5.png" alt="ocupacional-5">
                            <p>Metodología de análisis<br><span>iso</span></p>
                        </li>
                    </ul>
                </div>
            </div>
