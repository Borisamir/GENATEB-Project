    ...
    <main>
        ...
        <div class="contenedor-imagen-texto">
            <div class="imagen-texto" style="width: 400px;margin-top:50px">
                <img src="<?php echo $_ENV["RESOURCES"]; ?>/Imagenes_Estudios_Complementarios\Lupa.png" style="width: 137px;height: 131px;">
                <p>Respuestas ante emergencias y<br>conflictos socioambientales</p>
            </div>
            <div class="imagen-texto" style="width: 400px;margin-top:65px">
                <img src="<?php echo $_ENV["RESOURCES"]; ?>/Imagenes_Estudios_Complementarios\Gotas.png" style="width: 117px;height: 117px;" >
                <p>Acreditación de disponibilidad<br>hidrica y derechos de uso de agua</p>
            </div>
        </div>
        <div class="contenedor-imagen-texto">
            <div class="imagen-texto" style="width: 400px;margin-top:50px">
                <img src="<?php echo $_ENV["RESOURCES"]; ?>/Imagenes_Estudios_Complementarios\Planeta.png" style="width: 128px;height: 128px;">
            ...
            <div class="imagen-texto" style="width: 400px;margin-top:45px">
                <img src="<?php echo $_ENV["RESOURCES"]; ?>/Imagenes_Estudios_Complementarios\Hojas.png" style="width: 107px;height: 132px;" >
                <p>Modificacion y actualización<br>de Estudio de Impacto <br>Ambiental</p>
            </div>
        </div>
        <div class="contenedor-imagen-texto">
            <div class="imagen-texto" style="width: 400px;margin-top:50px">
                <img src="<?php echo $_ENV["RESOURCES"]; ?>/Imagenes_Estudios_Complementarios\Toxico.png" style="width: 102px;height: 129px;">
            ...
            <div class="imagen-texto" style="width: 400px;margin-top:60px">
                <img src="<?php echo $_ENV["RESOURCES"]; ?>/Imagenes_Estudios_Complementarios\Flechas.png" style="width: 131px;height: 121px;" >
                <p>Estudios de<br>Impacto<br>Vial (EIV)</p>
            </div>
        </div>
        <div class="contenedor-imagen-texto">
            <div class="imagen-texto" style="width: 300px;margin-top:-10px">
                <img src="<?php echo $_ENV["RESOURCES"]; ?>/Imagenes_Estudios_Complementarios\Peligro.png" style="width: 143px;height: 143px;">
                ...
                <div class="carrusel-wrapper">
                  <div class="services-car font-inter">
                     <div class="servicio-item">
                         ...
                         <a class="green-button boton-sobre-imagen" href="<?php echo $_ENV["SERVICES"]; ?>/monitoreo-ocupacional.php">VER MÁS</a>
                     </div>
                     <div class="servicio-item">
